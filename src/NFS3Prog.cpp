...
static std::string wstring_to_dbcs(const std::wstring& wstr) {
    int wlen = WideCharToMultiByte(CP_ACP, 0, wstr.c_str(), -1, nullptr, 0, nullptr, nullptr);
    std::string dbcsStr;
    dbcsStr.resize(wlen);
    WideCharToMultiByte(CP_ACP, 0, wstr.c_str(), -1, &dbcsStr[0], wlen, nullptr, nullptr);
    return dbcsStr;
}
...
{
    SetSize((unsigned int)strlen(str));
...
typedef nfsstat3_32(CNFS3Prog::*PPROC)(void);

CNFS3Prog::CNFS3Prog() : CRPCProg(), m_nResult(), m_pInStream(), m_pOutStream(), m_pParam()
{
    m_nUID = m_nGID = 0;
}
...
nfsstat3_32 CNFS3Prog::ProcedureNULL(void)
{
    PrintLog("NULL");
    return NFS3_OK;
}

nfsstat3_32 CNFS3Prog::ProcedureGETATTR(void)
{
    std::string path;
...
nfsstat3_32 CNFS3Prog::ProcedureSETATTR(void)
{
    std::string path;
...
nfsstat3_32 CNFS3Prog::ProcedureLOOKUP(void)
{
    char *path;
    nfs_fh3 object;
...
nfsstat3_32 CNFS3Prog::ProcedureACCESS(void)
{
    std::string path;
    uint32 access;
    post_op_attr obj_attributes;
...
nfsstat3_32 CNFS3Prog::ProcedureREADLINK(void)
{
    PrintLog("READLINK");
    std::string path;
    char *pMBBuffer = 0;
            ...
            if (!lpOutBuffer) {
                ...
                if (lpOutBuffer->ReparseTag == IO_REPARSE_TAG_SYMLINK || lpOutBuffer->ReparseTag == IO_REPARSE_TAG_MOUNT_POINT)
                {
                    if (lpOutBuffer->ReparseTag == IO_REPARSE_TAG_SYMLINK)
                    {
                        ...
                        delete[] szPrintName;
                        std::string cPrintName = wstring_to_dbcs(wStringTemp);
                    ...
                    if (lpOutBuffer->ReparseTag == IO_REPARSE_TAG_MOUNT_POINT)
                    {
                        ...
                        delete[] szSubName;
                        std::string target = wstring_to_dbcs(wStringTemp);
                        target.erase(0, 2);
                        target.insert(0, 2, '\\');
...
nfsstat3_32 CNFS3Prog::ProcedureREAD(void)
{
    std::string path;
    offset3_64 offset;
    count3_32 count;
...
nfsstat3_32 CNFS3Prog::ProcedureWRITE(void)
{
    std::string path;
    offset3_64 offset;
    count3_32 count;
...
nfsstat3_32 CNFS3Prog::ProcedureCREATE(void)
{
    char *path = NULL;
    createhow3 how{};
    post_op_fh3 obj{};
...
nfsstat3_32 CNFS3Prog::ProcedureMKDIR(void)
{
    char *path;
    sattr3 attributes{};
    post_op_fh3 obj{};
...
nfsstat3_32 CNFS3Prog::ProcedureSYMLINK(void)
{
    PrintLog("SYMLINK");
...
nfsstat3_32 CNFS3Prog::ProcedureMKNOD(void)
{
    //TODO
    PrintLog("MKNOD");
...
nfsstat3_32 CNFS3Prog::ProcedureREMOVE(void)
{
    char *path;
    wcc_data dir_wcc;
    nfsstat3_32 stat;
...
nfsstat3_32 CNFS3Prog::ProcedureRMDIR(void)
{
    char *path;
    wcc_data dir_wcc;
    nfsstat3_32 stat;
...
nfsstat3_32 CNFS3Prog::ProcedureRENAME(void)
{
...
nfsstat3_32 CNFS3Prog::ProcedureLINK(void)
{
    PrintLog("LINK");
    std::string path;
    diropargs3 link;
...
nfsstat3_32 CNFS3Prog::ProcedureREADDIR(void)
{
    std::string path;
    cookie3_64 cookie;
...
nfsstat3_32 CNFS3Prog::ProcedureREADDIRPLUS(void)
{
    std::string path;
    cookie3_64 cookie;
    cookieverf3_64 cookieverf;
...
nfsstat3_32 CNFS3Prog::ProcedureFSSTAT(void)
{
    std::string path;
    post_op_attr obj_attributes;
...
nfsstat3_32 CNFS3Prog::ProcedureFSINFO(void)
{
    std::string path;
    post_op_attr obj_attributes;
...
nfsstat3_32 CNFS3Prog::ProcedurePATHCONF(void)
{
    std::string path;
    post_op_attr obj_attributes;
    nfsstat3_32 stat;
...
nfsstat3_32 CNFS3Prog::ProcedureCOMMIT(void)
{
    std::string path;
    int handleId;
    offset3_64 offset;
...
nfsstat3_32 CNFS3Prog::ProcedureNOIMP(void)
{
    PrintLog("NOIMP");
...
nfsstat3_32 CNFS3Prog::CheckFile(const char *fullPath)
{
    if (fullPath == NULL) {
        return NFS3ERR_STALE;
    }
...
nfsstat3_32 CNFS3Prog::CheckFile(const char *directory, const char *fullPath)
{
